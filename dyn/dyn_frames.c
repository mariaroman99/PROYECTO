...
byte TxPacket(byte bID, byte bParameterLength, byte bInstruction,
    ...
    //La instrucci� no ha de poder modificar les primeres 5 posicions de memoria
    /*Variable estatica para no poder modificar las primeras 5 instrucciones al ejecutar
